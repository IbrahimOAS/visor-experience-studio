...
const plans = [
  {
    ...
    price: "€0",
    period: "forever",
    features: ["Basic AI transformation (1/month)", "Ritual tracking", "Community leaderboard", "Basic workout plans"],
    cta: "Get Started",
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    price: "€149",
    period: "one-time",
    features: ["Everything in Pro", "Lifetime access", "Priority AI generation", "Early access to new features"],
    cta: "Get Lifetime",
    highlighted: false,
  },
];
