    ...
    <div ref={wrapRef} className={`relative ${className}`}>
      ...
      {open && (
        <ul
          ...
          className={`${dropdownMode === "static" ? "relative w-full" : `absolute ${align === "left" ? "left-0" : "right-0"} w-[min(220px,calc(100vw-2rem))]`} mt-2 glass-card-strong rounded-2xl border border-white/10 overflow-hidden z-[80] shadow-xl focus:outline-none`}
        >
