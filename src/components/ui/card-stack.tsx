              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-[#99FFFF]" : "bg-white/30 hover:bg-white/50",
                  )}
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag ? (
          <span className="mb-2 inline-flex w-fit rounded-full border border-[#99FFFF]/30 bg-[#99FFFF]/10 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#99FFFF]">
            {item.tag}
          </span>
        ) : null}
